...
func _ready() -> void:
	...
	countdown_lbl.add_theme_font_size_override("font_size", 32)
	...
	reject_btn.add_theme_font_size_override("font_size", 44)
	reject_btn.custom_minimum_size = Vector2(0, 90)
